//
//  ViewControllerSaoCristovao.swift
//  TuristandoRio
//
//  Created by Denilson Monteiro on 21/09/16.
//  Copyright © 2016 Infnet. All rights reserved.
//

import UIKit

class ViewControllerSaoCristovao: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        if let placesPath = NSBundle.mainBundle().pathForResource("Places_sao_cristovao", ofType: "plist") {
