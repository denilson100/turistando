...
class ViewControllerBarra: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        if let placesPath = NSBundle.mainBundle().pathForResource("Places_barra", ofType: "plist") {
